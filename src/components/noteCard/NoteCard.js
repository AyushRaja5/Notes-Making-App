...
import './notecard.css'; // Import the CSS file
...
function NotesCard() {
  ...
  const { allnotes, loading, getallnotes } = context;
          ...
          {loading ?
            <>
              <div className='loading-div'>
                <img src='https://i.gifer.com/origin/b1/b128497bc8d6fcfefb93b88b260561a7_w200.gif' alt='loading...' />
              </div>
            </>
            :
            <>
              {
                allnotes.length > 0 ? allnotes.map((item, index) => (
                  <div key={index} className="mb-3">
                    <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden notebox">
                      <div className="p-6">
                        <h1 className="text-lg font-medium text-gray-900 mb-3">{item.title}</h1>
